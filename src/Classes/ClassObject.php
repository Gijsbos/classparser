...
class ClassObject extends \ReflectionClass
{
    ...
    private function getContentArray() : array
    {
        ...
        // Create merged
        $merged = array_replace($this->comments, $constants, $properties, $methods);
        ...
        if(count($merged) === 0)
            return array_merge($this->component->constants, $this->component->properties, $this->component->methods);
